        ...
        <div class="container-fluid px-3 px-lg-4 py-4">
          ...
          <section class="row g-3">
            <div class="col-12 col-xl-12">
                ...
                @endif
              <form action="{{ route('district.update', $district->id) }}" class="panel needs-validation" method="post" novalidate>
                ...
                <div class="row g-3">
                    <div class="col-md-6"><label class="form-label" for="formName">District name</label><input class="form-control" id="formName" type="text" name="name" value="{{ old('name', $district->name) }}" required>
