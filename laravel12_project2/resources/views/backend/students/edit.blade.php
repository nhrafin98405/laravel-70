...
@endif
              ...
              <form method="POST" action="{{route('student.update',$student->id)}}" class="panel needs-validation" novalidate>
                ...
                <div class="row g-3">
                  ...
                  <div class="col-md-6">
                    ...
                    <input class="form-control" id="firstName" name="fullname" type="text" value="{{old('fullname',$student->name)}}" required>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="gender" id="other" value="other" {{old('gender',$student->gender)=='others'?'checked':''}}>
                  ...
                  <div class="col-md-6"><label class="form-label" for="email">Email</label><input class="form-control" value="{{old('email',$student->email)}}" name="email" type="email" required><div class="invalid-feedback">Enter a valid email.</div></div>


                  <div class="col-md-6"><label class="form-label" for="phone">Phone</label><input class="form-control" value="{{old('phone',$student->phone)}}" name="phone" type="tel" required><div class="invalid-feedback">Phone number is required.</div></div>
                  ...
                  <div class="col-md-6"><label class="form-label" for="role">District</label>
                    <select class="form-select" id="role" name="district" required>
                      ...
                      <option value="dhaka"{{old('district',$student->district)=='dhaka'?'selected':''}}>Dhaka</option>
                      <option value="khulna"{{old('district',$student->district)=='khulna'?'selected':''}}>khulna</option>
                      <option value="mymensingh"{{old('district',$student->district)=='mymensingh'?'selected':''}}>Mymensingh</option>
                      <option value="haluaghat"{{old('district',$student->district)=='haluaghat'?'selected':''}}>Haluaghat</option>
                    </select>
                ...
                <div class="d-flex flex-wrap justify-content-end gap-2 mt-4"><a class="btn btn-outline-secondary" href="users.html">Cancel</a><button class="btn btn-primary" type="submit"><i class="bi bi-person-check" aria-hidden="true"></i> Update Student </button></div>
              </form>
            </div>
